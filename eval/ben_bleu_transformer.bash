...
python3 ../tensor2tensor/utils/avg_checkpoints.py --num_last_checkpoints 5 --output_path "checkpoints_transformer/averaged.ckpt" --prefix "../../t2t_train/final_run_romanian/final_first_romanian_trans/"
...
#t2t-decoder --data_dir=../../t2t_data --problems=translate_roen_wmt8k --model=transformer --hparams_set=transformer_base_single_gpu --output_dir=../../t2t_train/final_run_romanian#/final_first_romanian_trans --decode_interactive --decode_hparams="return_beams=True,beam_size=15"


t2t-decoder   --data_dir=${data_dir}   --problems=${problem}   \
	      --model=transformer   --hparams_set=transformer_base_single_gpu   \
	      --output_dir=checkpoints_transformer/  --decode_hparams="beam_size=10"\
	      --decode_from_file=${input_file}.src.${lang1}\
	      --decode_to_file=${input_file}.trans.${lang2}

cp newsdev2016-roen.trans.en.transformer.transformer_base_single_gpu.translate_roen_wmt8k.beam10.alpha0.6.decodes ${input_file}.trans.${lang2}
